...
rex_sql_table::get(rex::getTable('module'))
    ->ensureColumn(new rex_sql_column('nv_modulepreview_thumbnail', 'text'))
...
$sql->setQuery("INSERT INTO " . \rex::getTablePrefix() . "media_manager_type (`status`, `name`, `description`) VALUES
        (0, 'nv_modulepreview_thumbnail', 'Mediatype für die Thumbnails in der Blockauswahl. (nv_modulepreview)');");
